...
SRC_BONUS = $(BONUS_DIR)so_long_bonus.c map_parser.c error_handler.c map_validator.c map_path_validator.c map_utils.c \
$(BONUS_DIR)loops_and_hooks.c $(BONUS_DIR)animation_bonus.c $(BONUS_DIR)input.c $(BONUS_DIR)logic.c $(BONUS_DIR)player.c map_drawer.c \
